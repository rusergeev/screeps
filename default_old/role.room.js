...
module.exports = {
    ...
    run: function (room) {
        ...
        if(room.controller && room.controller.my){
            Memory.stats['rooms.' + room.name + '.rcl.level'] = room.controller.level;
            Memory.stats['rooms.' + room.name + '.rcl.progress'] = room.controller.progress;
            Memory.stats['rooms.' + room.name + '.rcl.progressTotal'] = room.controller.progressTotal;
            Memory.stats['rooms.' + room.name + '.spawn.energy'] = room.energyAvailable;
            Memory.stats['rooms.' + room.name + '.spawn.energyTotal'] = room.energyCapacityAvailable;
            Memory.stats['rooms.' + room.name + '.spawn.energyFlow'] = flow;
            if(room.storage){
                Memory.stats['rooms.' + room.name + '.storage.energy'] = room.storage.store.energy;
            }
        }
